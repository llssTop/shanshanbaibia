<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\wamp64\www\shanshanbaibia\public/../application/index\view\detail\introduction.html";i:1503459714;s:73:"F:\wamp64\www\shanshanbaibia\public/../application/index\view\layout.html";i:1503406376;}*/ ?>
...
<body>
        ...
        <link href="__HCSS_PATH__amazeui.css" rel="stylesheet" type="text/css" />
		<link href="__HCSS_PATH__demo.css" rel="stylesheet" type="text/css" />
		<link type="text/css" href="__HCSS_PATH__optstyle.css" rel="stylesheet" />
		<link type="text/css" href="__HCSS_PATH__style.css" rel="stylesheet" />
		<script type="text/javascript" src="__HJS_PATH__jquery-1.7.min.js"></script>
		<script type="text/javascript" src="__HJS_PATH__quick_links.js"></script>
		<script type="text/javascript" src="__HJS_PATH__jquery.imagezoom.min.js"></script>
		<script type="text/javascript" src="__HJS_PATH__jquery.flexslider.js"></script>
		<script type="text/javascript" src="__HJS_PATH__list.js"></script>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="__HIMG_PATH__01.jpg" title="pic" />
								</li>
								<li>
									<img src="__HIMG_PATH__02.jpg" />
								</li>
								<li>
									<img src="__HIMG_PATH__03.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="__HIMG_PATH__01.jpg"><img src="__HIMG_PATH__01_mid.jpg" alt="细节展示放大镜特效" rel="__HIMG_PATH__01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="__HIMG_PATH__01_small.jpg" mid="__HIMG_PATH__01_mid.jpg" big="__HIMG_PATH__01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="__HIMG_PATH__02_small.jpg" mid="__HIMG_PATH__02_mid.jpg" big="__HIMG_PATH__02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="__HIMG_PATH__03_small.jpg" mid="__HIMG_PATH__03_mid.jpg" big="__HIMG_PATH__03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
							...
							<dl class="iteminfo_parameter freight">
								...
								<div class="iteminfo_freprice">
									<div class="am-form-content address">
										...
										<select id="cmbProvince" name="cmbProvince"  style="width:80px;"></select>  
				                        <select id="cmbCity" name="cmbCity" style="width:80px;" ></select>  
				                        <select id="cmbArea" name="cmbArea" style="width:80px;"></select>  
										<script type="text/javascript">  
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-right">
													<div class="img-info">
														<img src="__HIMG_PATH__songzi.jpg" />
													</div>
													<div class="text-info">
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="__HIMG_PATH__browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="__HIMG_PATH__tw1.jpg" />
											<img src="__HIMG_PATH__tw2.jpg" />
											<img src="__HIMG_PATH__tw3.jpg" />
											<img src="__HIMG_PATH__tw4.jpg" />
											<img src="__HIMG_PATH__tw5.jpg" />
											<img src="__HIMG_PATH__tw6.jpg" />
											<img src="__HIMG_PATH__tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="__HIMG_PATH__hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
										...
										<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
											<li>
												<div class="i-pic limit">
													<img src="__HIMG_PATH__imgsearch1.jpg" />
